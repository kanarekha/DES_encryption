...
# Matriks permutasi setelah Subs ke Sbox
pbox = [16, 7, 20, 21,
       29, 12, 28, 17,
       1, 15, 23, 26,
       5, 18, 31, 10,
...
# Matriks S-box untuk substitusi 8 blok S1 sampai S8
...
def encrypt(pt, rkb, rk):
    ...
    for i in range(0, 16):
        ...
        # Hasil dari ekspansi blok kanan di XOR-kan dan mengasilkan 48 bit
        xor_x = xor(right_expanded, rkb[i])

        # Dibagi menjadi 8 blok yang terdiri masing masing 6 bit . Lalu di substitusi ke Sbox
        sbox_str = ""
        for j in range(0, 8):
        ...
        # dilakukan permutasi untuk mengacak hasil substitusi sbox
        sbox_str = permute(sbox_str, pbox, 32)

        # bit pada sbox_str di XOR dengan blok bagian kiri untuk mendapatkan bit blok bagian kanan
    ...
    # Melakukan final permutasi untuk mendapakan chiper text
    cipher_text = permute(combine, final_permute, 64)
    return cipher_text

len_of_data = 16
len_of_key = 14
plain_text = "432123CEDD982742"
key = "ABDE87257162DDCE"
...
# Matriks permutasi kompresi PC-2 dari 56 bit menjadi 48 bit
...
if len(plain_text) == len_of_data and len(bin_to_hex(key)) == len_of_key:
    print("Encryption")
    ...
    print("Length of Plain Text entered :",len(plain_text))
    print("Length of Key entered :",len(bin_to_hex(key)))
